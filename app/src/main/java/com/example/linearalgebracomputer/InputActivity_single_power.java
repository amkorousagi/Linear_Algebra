...
public class InputActivity_single_power extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_single_power);
        ...
        String[] str2 = getResources().getStringArray(R.array.spinnerArray5);
        ...
        spinner_field2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinner_field2.getSelectedItemPosition() > 0) {
                    ...
                    colb = parseInt(spinner_field2.getSelectedItem().toString());
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < row; i++) {
                    for (int j = 0; j < row; j++) {
                        ...
                        matrix[i*row + j] = parseFloat(input.getText().toString());
                    }
                }
